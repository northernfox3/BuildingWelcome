...
<html>
    <head>
        ...
        <meta charset="UTF-8">
        <title>Studnet information</title>
...
.zebra tfoot td:only-child{
    ...
    echo "</tr>";
            ...
            <table class="bordered">
                ...
                $sql = "SELECT * FROM student_list WHERE " . $_POST['seltype'] . " LIKE ('%" . $_POST['coun'] . "%')";
                $rs = mysqli_query($conn, $sql) or die("Enter Student ID or Student Name to Search.");
