...
.zebra tfoot td:only-child{
    ...
    border-radius： 0 0 6px 6px
      ...
      <body align="center">
          ...
          <h3 class="glow">Please Enter the Meeting Passkey</h3>
            ...
            <table class="bordered">
                ...
                <h1>
                <button  class = "button" onclick="window.location.href='login.php'">EXIT</button>
                </h1>
              ...
              echo "<p style='color:cornflowerblue;'> The Passkey is not correct!";
            }
            ?>
            </table>
            <br/>
